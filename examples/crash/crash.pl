...
t(_)::rank_assignment([danger(agent), 1, danger(c1), 1, danger(c2), 1, responsible(agent), 1]);    
t(_)::rank_assignment([danger(agent), 1, danger(c1), 1, danger(c2), 1, responsible(agent), 2]);    
t(_)::rank_assignment([danger(agent), 1, danger(c1), 2, danger(c2), 2, responsible(agent), 1]);    
t(_)::rank_assignment([danger(agent), 1, danger(c1), 2, danger(c2), 2, responsible(agent), 2]);    
t(_)::rank_assignment([danger(agent), 2, danger(c1), 1, danger(c2), 1, responsible(agent), 1]);    
t(_)::rank_assignment([danger(agent), 2, danger(c1), 1, danger(c2), 1, responsible(agent), 2]);    
t(_)::rank_assignment([danger(agent), 2, danger(c1), 2, danger(c2), 2, responsible(agent), 1]);    
t(_)::rank_assignment([danger(agent), 2, danger(c1), 2, danger(c2), 2, responsible(agent), 2]).

% --------- Background knowledge - Types and constants ---------
